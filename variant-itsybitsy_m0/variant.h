...
// Serial1
#define PIN_SERIAL1_RX       (0ul) //PA11 differs from trinket
#define PIN_SERIAL1_TX       (1ul) //PA10
#define PAD_SERIAL1_TX       (UART_TX_PAD_2)  //same as trinket
#define PAD_SERIAL1_RX       (SERCOM_RX_PAD_3)//same as trinket
